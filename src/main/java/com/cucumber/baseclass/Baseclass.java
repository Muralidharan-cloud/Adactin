	...
	public static WebDriver getDriver(String browsername) throws Exception {
		try {
			if (browsername == "chrome") {
				System.setProperty("webdriver.chrome.driver", "C:\\Users\\muralidharan\\workspace\\cucumberday2\\src\\test\\resource\\com\\cucumber\\drivers\\chromedriver.exe");
				driver = new ChromeDriver();
			} else if (browsername == "firefox") {
				System.setProperty("webdriver.gecko.driver",
						"C:\\Users\\muralidharan\\workspace\\Seleniumday2\\driver\\geckodriver.exe");
